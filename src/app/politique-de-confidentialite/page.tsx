  ...
  return (
    <div className="min-h-screen bg-[#07070f] text-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          <p className="text-[10px] font-bold tracking-[0.15em] text-violet-400 uppercase mb-2">RGPD · EU AI Act</p>
        ...
        <div className="space-y-10 text-sm text-slate-400 leading-relaxed">
          ...
          <section>
            ...
            <div className="p-4 rounded-xl border border-white/[0.06] bg-white/[0.03] space-y-1">
              <p><span className="text-slate-600">Responsable :</span> <span className="text-slate-300">Vilmen Matthieu</span></p>
              <p>
                <span className="text-slate-600">Contact DPO :</span>{" "}
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-xl border border-white/[0.06] bg-white/[0.03]">
                <p className="font-semibold text-slate-300 mb-2">Données du quiz (non persistées)</p>
                <p>Les réponses au quiz sont traitées <strong className="text-slate-300">uniquement dans ton navigateur</strong> (sessionStorage). Elles ne sont jamais envoyées ni stockées sur nos serveurs. Elles sont effacées dès la fermeture de l&apos;onglet.</p>
              </div>

              <div className="p-4 rounded-xl border border-white/[0.06] bg-white/[0.03]">
                <p className="font-semibold text-slate-300 mb-2">Données de contact (formulaire de rapport)</p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">3. Base légale des traitements</h2>
            <div className="space-y-2">
              {[
                ...
                <div key={traitement} className="p-3 rounded-lg border border-white/[0.06] bg-white/[0.02] text-xs">
                  <p className="font-semibold text-slate-300">{traitement}</p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">4. Durée de conservation</h2>
            <div className="p-4 rounded-xl border border-white/[0.06] bg-white/[0.03] space-y-2 text-xs">
              <p><span className="text-slate-500">Données du quiz :</span> <span className="text-slate-300">Durée de la session navigateur uniquement</span></p>
              <p><span className="text-slate-500">Données de contact :</span> <span className="text-slate-300">3 ans à compter du dernier contact</span></p>
              <p><span className="text-slate-500">Après expiration :</span> <span className="text-slate-300">Suppression définitive de la base de données</span></p>
            </div>
          </section>

          <section>
            <h2 className="text-base font-bold text-white mb-3">5. Destinataires des données</h2>
            <div className="space-y-3">
              <div className="p-4 rounded-xl border border-white/[0.06] bg-white/[0.03]">
                <p className="font-semibold text-slate-300 mb-1">Sous-traitants techniques</p>
                <ul className="space-y-1 text-xs">
                  <li className="flex gap-2"><span className="text-slate-600 flex-shrink-0">Supabase Inc.</span><span>Stockage de la base de données — région EU (Irlande)</span></li>
                  <li className="flex gap-2"><span className="text-slate-600 flex-shrink-0">Vercel Inc.</span><span>Hébergement de l&apos;application — serveurs edge EU</span></li>
                </ul>
              </div>
              <div className="p-4 rounded-xl border border-violet-500/20 bg-violet-500/[0.05]">
                <p className="font-semibold text-slate-300 mb-1">Organismes de formation partenaires</p>
                <p className="text-xs">Tes données de contact (prénom, email, téléphone si fourni, profil RIASEC) peuvent être transmises à des organismes de formation sélectionnés, <strong className="text-slate-300">uniquement avec ton consentement explicite</strong> recueilli lors du formulaire. Tu peux retirer ce consentement à tout moment.</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-base font-bold text-white mb-3">6. Tes droits (RGPD art. 15 à 22)</h2>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={droit} className="flex items-start gap-2.5 text-xs">
                  <span className="text-violet-500 flex-shrink-0 mt-0.5">▸</span>
                  <span><strong className="text-slate-300">{droit}</strong> — {description}</span>
                </li>
              ))}
            </ul>
            <div className="mt-4 p-4 rounded-xl border border-white/[0.06] bg-white/[0.03]">
              <p className="text-xs">Pour exercer ces droits, contacte-nous à{" "}
                <a href="mailto:vilmenmatthieu@gmail.com" className="text-violet-400 hover:text-violet-300 transition-colors">
                  vilmenmatthieu@gmail.com
                </a>{" "}
                avec l&apos;objet <strong className="text-slate-300">« Droits RGPD »</strong>. Réponse sous 30 jours maximum. Tu peux également adresser une réclamation à la <strong className="text-slate-300">CNIL</strong> (cnil.fr).
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-base font-bold text-white mb-3">7. Cookies</h2>
            <p>
              Ce site n&apos;utilise <strong className="text-slate-300">aucun cookie de traçage ou publicitaire</strong>. Le seul stockage utilisé est le <code className="text-violet-400 text-xs bg-violet-500/10 px-1.5 py-0.5 rounded">sessionStorage</code> du navigateur pour les réponses au quiz, effacé automatiquement en fin de session.
            </p>
          </section>

          <section>
            <h2 className="text-base font-bold text-white mb-3">8. Sécurité</h2>
            <p>
